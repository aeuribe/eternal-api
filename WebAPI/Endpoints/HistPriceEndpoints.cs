...
namespace eternal_api.WebAPI.Endpoints
{
    public static class HistPriceEndpoints
    {
        public static void MapHistPriceEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            app.MapGet("/histprices/product/{productId:guid}", async (Guid productId, IMediator mediator) =>
            {
            ...
            app.MapGet("/histprices/latest/{productId:guid}", async (Guid productId, IMediator mediator) =>
            {
            ...
            app.MapGet("/histprices/by-date/{productId:guid}/{date}", async (Guid productId, DateTime date, IMediator mediator) =>
            {
